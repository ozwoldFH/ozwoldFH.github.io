...
gj.grid.messages['bg-bg'] = {
    ...
    FirstPageTooltip: 'ÐŸÑŠÑ€Ð²Ð° Ð¡Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°',
    PreviousPageTooltip: 'ÐŸÑ€ÐµÐ´Ð¸ÑˆÐ½Ð° Ð¡Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°',
    NextPageTooltip: 'Ð¡Ð»ÐµÐ´Ð²Ð°Ñ‰Ð° Ð¡Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°',
    LastPageTooltip: 'ÐŸÐ¾ÑÐ»ÐµÐ´Ð½Ð° Ð¡Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°',
    Refresh: 'ÐŸÑ€ÐµÐ·Ð°Ñ€ÐµÐ¶Ð´Ð°Ð½Ðµ',
    Of: 'Ð¾Ñ‚',
    DisplayingRecords: 'ÐŸÐ°ÐºÐ°Ð·Ð°Ð½Ð¸ Ð·Ð°Ð¿Ð¸ÑÐ¸',
    RowsPerPage: 'Ð ÐµÐ´Ð¾Ð²Ðµ Ð½Ð° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°:',
    Edit: 'Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð°Ð½Ðµ',
    Delete: 'Ð˜Ð·Ñ‚Ñ€Ð¸Ð²Ð°Ð½Ðµ',
    Update: 'ÐÐºÑ‚ÑƒÐ°Ð»Ð¸Ð·Ð°Ñ†Ð¸Ñ',
    Cancel: 'ÐžÑ‚ÐºÐ°Ð·',
    NoRecordsFound: 'ÐÑÐ¼Ð° Ð½Ð°Ð¼ÐµÑ€ÐµÐ½Ð¸ Ð·Ð°Ð¿Ð¸ÑÐ¸.',
...
gj.grid.messages['fr-fr'] = {
    ...
    Last: 'Dernier',
    Page: 'Page',
    FirstPageTooltip: 'PremiÃ¨re page',
    PreviousPageTooltip: 'Page prÃ©cÃ©dente',
    NextPageTooltip: 'Page suivante',
    LastPageTooltip: 'DerniÃ¨re page',
    Refresh: 'RafraÃ®chir',
    Of: 'de',
    DisplayingRecords: 'RÃ©sultats',
    RowsPerPage: 'Lignes par page:',
    Edit: 'Modifier',
    Delete: 'Effacer',
    Update: 'Mettre Ã  jour',
    Cancel: 'Annuler',
    NoRecordsFound: 'Aucun enregistrement trouvÃ©.',
    Loading: 'Chargement...'
};
...
gj.grid.messages['pt-br'] = {
    ...
    Last: 'Ãšltimo',
    Page: 'PÃ¡gina',
    FirstPageTooltip: 'Primeira pÃ¡gina',
    PreviousPageTooltip: 'PÃ¡gina anterior',
    NextPageTooltip: 'PrÃ³xima pÃ¡gina',
    LastPageTooltip: 'Ãšltima PÃ¡gina',
    Refresh: 'Atualizar',
    Of: 'de',
...
gj.grid.messages['ru-ru'] = {
    ...
    Page: 'Ð¡Ñ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°',
    FirstPageTooltip: 'ÐŸÐµÑ€Ð²Ð°Ñ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°',
    PreviousPageTooltip: 'ÐŸÑ€ÐµÐ´Ñ‹Ð´ÑƒÑ‰Ð°Ñ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°',
    NextPageTooltip: 'Ð¡Ð»ÐµÐ´ÑƒÑ‰Ð°Ñ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°',
    LastPageTooltip: 'ÐŸÐ¾ÑÐ»ÐµÐ´Ð½ÑÑ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ð°',
    Refresh: 'ÐžÐ±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ',
    Of: 'Ð¾Ñ‚',
    DisplayingRecords: 'ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð·Ð°Ð¿Ð¸ÑÐ¸',
    RowsPerPage: 'Ð—Ð°Ð¿Ð¸ÑÐµÐ¹ Ð½Ð° ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ðµ:',
    Edit: 'Ð˜Ð·Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ',
    Delete: 'Ð£Ð´Ð°Ð»Ð¸Ñ‚ÑŒ',
    Update: 'ÐžÐ±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ',
    Cancel: 'ÐžÑ‚Ð¼ÐµÐ½Ð°',
    NoRecordsFound: 'ÐÐµÑ‚ Ð½Ð¸ Ð¾Ð´Ð½Ð¾Ð¹ Ð·Ð°Ð¿Ð¸ÑÐ¸.',
...
gj.grid.messages['tr-tr'] = {
    ...
    Last: 'Son',
    Page: 'Sayfa',
    FirstPageTooltip: 'Ä°lk sayfa',
    PreviousPageTooltip: 'Ã–nceki sayfa',
    NextPageTooltip: 'Sonraki sayfa',
    LastPageTooltip: 'Son sayfa',
    Refresh: 'Yenile',
    Of: 'Ã¼zerinden',
    DisplayingRecords: 'SonuÃ§lar',
    RowsPerPage: 'Lignes par page:',
    Edit: 'DÃ¼zenle',
    Delete: 'Sil',
    Update: 'GÃ¼ncelle',
    Cancel: 'Ä°ptal',
    NoRecordsFound: 'KayÄ±t Yok.',
    Loading: 'YÃ¼kleniyor...'
};
gj.grid.messages['ja-jp'] = {
    ...
    Last: 'æœ€å¾Œ',
    Page: 'ãƒšãƒ¼ã‚¸',
    FirstPageTooltip: 'æœ€åˆã®ãƒšãƒ¼ã‚¸',
    PreviousPageTooltip: 'å‰ã®ãƒšãƒ¼ã‚¸',
    NextPageTooltip: 'æ¬¡ã®ãƒšãƒ¼ã‚¸',
    LastPageTooltip: 'æœ€å¾Œã®ãƒšãƒ¼ã‚¸',
    Refresh: 'ãƒªãƒ•ãƒ¬ãƒƒã‚·ãƒ¥',
    Of: 'ã®',
    DisplayingRecords: 'çµæžœ',
    RowsPerPage: 'ãƒšãƒ¼ã‚¸ã‚ãŸã‚Šè¡Œæ•°:',
    Edit: 'ç·¨é›†',
    Delete: 'å‰Šé™¤',
    Update: 'æ›´æ–°',
    Cancel: 'ã‚­ãƒ£ãƒ³ã‚»ãƒ«',
    NoRecordsFound: 'ãƒ¬ã‚³ãƒ¼ãƒ‰ãŒè¦‹ã¤ã‹ã‚Šã¾ã›ã‚“',
    Loading: 'èª­ã¿è¾¼ã¿ä¸­...'
};
gj.grid.messages['zh-cn'] = {
    ...
    Last: 'å°¾',
    Page: 'é¡µ',
    FirstPageTooltip: 'é¦–é¡µ',
    PreviousPageTooltip: 'ä¸Šä¸€é¡µ',
    NextPageTooltip: 'ä¸‹ä¸€é¡µ',
    LastPageTooltip: 'å°¾é¡µ',
    Refresh: 'åˆ·æ–°',
    Of: 'çš„',
    DisplayingRecords: 'æ­£åœ¨æ˜¾ç¤ºè®°å½•',
    RowsPerPage: 'è¡Œæ¯é¡µ',
    Edit: 'ç¼–è¾‘',
    Delete: 'åˆ é™¤',
    Update: 'æ›´æ–°',
    Cancel: 'å–æ¶ˆ',
    NoRecordsFound: 'æ‰¾ä¸åˆ°è®°å½•ã€‚',
    Loading: 'æ­£åœ¨åŠ è½½â€¦â€¦'
};
gj.grid.messages['zh-tw'] = {
    ...
    Last: 'å°¾',
    Page: 'é ',
    FirstPageTooltip: 'é¦–é ',
    PreviousPageTooltip: 'ä¸Šä¸€é ',
    NextPageTooltip: 'ä¸‹ä¸€é ',
    LastPageTooltip: 'å°¾é ',
    Refresh: 'åˆ·æ–°',
    Of: 'çš„',
    DisplayingRecords: 'æ­£åœ¨é¡¯ç¤ºè¨˜éŒ„',
    RowsPerPage: 'è¡Œæ¯é ',
    Edit: 'ç·¨è¼¯',
    Delete: 'åˆªé™¤',
    Update: 'æ›´æ–°',
    Cancel: 'å–æ¶ˆ',
    NoRecordsFound: 'æ‰¾ä¸åˆ°è¨˜éŒ„ã€‚',
    Loading: 'æ­£åœ¨åŠ è¼‰â€¦â€¦'
};